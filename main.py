...
# Tóm tắt: Không có docstring cho run_cli
def run_cli (target_file :str ):
    ...
    if result ["status"]=="success":
        ...
        if ai_result ["status"]=="success":
            ...
            console .print ("[yellow] Đang đưa test case vào buồng đốt (Execution Engine)...[/yellow]")
...
def main ():
    ...
    parser .add_argument ("file_path",nargs ="?",help ="Đường dẫn đến file source code cần test (Để trống để chạy giao diện Web)")
    ...
    if args .file_path :
        ...
        console .print ("[bold green] Đang khởi động Server Frontend trên http://127.0.0.1:8000 ...[/bold green]")
